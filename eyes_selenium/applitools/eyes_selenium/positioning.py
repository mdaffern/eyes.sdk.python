...
from eyes_core.positioning import PositionProvider
from eyes_selenium import EyesWebDriver

if tp.TYPE_CHECKING:
    from applitools.core.utils.custom_types import AnyWebDriver, AnyWebElement
...
class SeleniumPositionProvider(PositionProvider):
    ...
    def __init__(self, driver: EyesWebDriver):
        super().__init__()
        self._driver = driver

    def _execute_script(self, script: str) -> tp.List[int]:
...
def build_position_provider_for(stitch_mode,  # type: str
