...
from eyes_selenium.webdriver.common.by import By
from eyes_selenium.webdriver.remote.switch_to import SwitchTo
from eyes_selenium.webdriver.remote.webdriver import WebDriver
from eyes_selenium.webdriver.support.wait import WebDriverWait
...
class _EyesSwitchTo(object):
    """
    Wraps a eyes_selenium "SwitchTo" object, so we can keep track of switching between frames.
    """
...
class EyesWebDriver(object):
    """
    A wrapper for eyes_selenium web driver which creates wrapped elements, and notifies us about
    events / actions.
    """
    ...
    def find_elements(self, by=By.ID, value=None):
        # type: (str, str) -> tp.List[EyesWebElement]
        """
    ...
    def find_elements_by_id(self, id_):
        # type: (str) -> tp.List[EyesWebElement]
        """
