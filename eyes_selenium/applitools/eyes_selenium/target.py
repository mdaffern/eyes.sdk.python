...
class IgnoreRegionBySelector(object):
    def __init__(self, by, value):
        # type: (str, str) -> None
        """
        :param by: The "by" part of a eyes_selenium selector for an element which
            represents the ignore region
        :param value: The "value" part of a eyes_selenium selector for an element which represents the ignore region.
        """
        self.by = by
        self.value = value
...
class FloatingRegionBySelector(object):
    def __init__(self, by, value, bounds):
        ...
        :param value: The "value" part of a eyes_selenium selector for an element which represents the inner region.
        :param bounds: The outer rectangle bounding the inner region.
        """
        self.by = by
        self.value = value
