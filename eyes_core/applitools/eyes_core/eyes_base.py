...
from eyes_core.metadata import BatchInfo

from .utils import cached_property

from eyes_core.match import ImageMatchSettings
from . import logger
...
class EyesBase(abc.ABC):
    ...
    def __init__(self, server_url=DEFAULT_EYES_SERVER):
        ...
        self._app_name = None  # type: tp.Optional[str]
        ...
        self._test_name = None  # type: tp.Optional[str]
        ...
        self.agent_id = None  # type: tp.Optional[str]

        # Should the test report mismatches immediately or when it is finished. See FailureReports.
        self.failure_reports = FailureReports.ON_CLOSE  # type: str
        ...
        self.branch_name = None  # type: tp.Optional[str]

        # A string identifying the parent branch of the branch set by "branch_name".
        self.parent_branch_name = None  # type: tp.Optional[str]
    ...
    def open_base(self, app_name, test_name, viewport_size=None):
        # type: (str, str, tp.Optional[ViewPort]) -> None
        """
        Starts a test.
