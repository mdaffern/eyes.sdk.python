...
from eyes_core import logger, geometry, TestResults
...
def _parse_response_with_json_data(response):
    # type: (Response) -> tp.Dict[str, tp.Any]
...
class AgentConnector(object):
    ...
    def _send_long_request(name, method, *args, **kwargs):
        # type: (str, tp.Callable, *tp.Any, **tp.Any) -> Response
